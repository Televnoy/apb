...
const App = () => {
  ...
  // Notify index.html that we are loaded
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9] text-[#2C2C2C] pb-48 relative overflow-x-hidden">
      {toast && (
              ...
              <div className="bg-white rounded-2xl p-6 border border-[#EAEAEA] shadow-[0_4px_20px_rgba(0,0,0,0.02)] space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div className="relative">
                    ...
                    {isNumOpen && (
                      <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-[#EEE] z-[80] h-48 overflow-y-auto shadow-xl rounded-lg no-scrollbar">
